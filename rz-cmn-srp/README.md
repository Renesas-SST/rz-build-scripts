...
│   │   ├── renesas-ubuntu-rzg2l-sbc-<timestamp>.rootfs.manifest
│   │   ├── renesas-ubuntu-rzg2l-sbc-<timestamp>.testdata.json
│   │   ├── renesas-ubuntu-rzg2l-sbc.manifest -> renesas-ubuntu-rzg2l-sbc-<timestamp>.rootfs.manifest
│   │   └── renesas-ubuntu-rzg2l-sbc.testdata.json -> renesas-ubuntu-rzg2l-sbc-<timestamp>.testdata.json
│   ├── env
│   │   ├── core-image-bsp.env
