...
├── rootfs
|   └── ubuntu-lxde-image-rzg2l-sbc.tar.bz2         <---- Output compressed rootfs
└──  ubuntu-lxde-image-rzg2l-sbc.wic.gz             <---- Output compressed WIC
```
### U-boot environment
...
1. **Click on the Bluetooth Icon**: In the lower-left corner of the screen, you will find the you will find the LXDE icon. Click on it, then select Preferences. In the preferences window, choose `Bluetooth Manager` to access further settings.
